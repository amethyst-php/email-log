...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\EmailLog\EmailLog::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\EmailLog\EmailLogManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\EmailLog\EmailLogRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\EmailLog\EmailLogSerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\EmailLog\EmailLogValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\EmailLog\EmailLogAuthorizer::class,
    ...
    */
    'http' => [
        'admin' => [
            'enabled'    => true,
            'controller' => Railken\LaraOre\Http\Controllers\Admin\EmailLogsController::class,
            'router'     => [
                'prefix' => '/email-logs',
            ],
        ],
